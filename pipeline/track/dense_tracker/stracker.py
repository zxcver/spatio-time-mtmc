...
class STrack(BaseTrack):
    ...
    def __init__(self, tlwh, score, temp_feat, feat_alpha, buffer_size=30):
        # save src det
    ...
    def activate(self, kalman_filter,frame_id, _count):
    ...
    def re_activate(self, new_track, frame_id, _count, new_id=False):
